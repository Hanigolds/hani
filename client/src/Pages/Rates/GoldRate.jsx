...
const GoldRate = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch(`${url}/api/gold/create`, {
        method: 'POST',
        headers: {
  ...
  const handleRateDelete = async (id) => {
    ...
    try {
      const response = await fetch(`${url}/api/gold/delete/${id}`, {
        method: 'DELETE',
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const getAllRates = async() =>{
    try {
      const response = await fetch(`${url}/api/gold/gets`, {
        method: 'GET',
        headers: {
          "Content-Type": "application/json",
        },
